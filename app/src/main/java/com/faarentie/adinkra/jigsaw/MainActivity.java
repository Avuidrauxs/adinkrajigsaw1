...
public class MainActivity extends Activity {
	...
	//AUDAX EDITS
	Typeface typeface;
	TextSwitcher adinkra_desc;
    ImageView reloadBtn;
	
	//AUDAX EDITS END HERE
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//AUDAX EDITS
		typeface = Typeface.createFromAsset(getAssets(), "fonts/african.ttf");
		reloadBtn = (ImageView) findViewById(R.id.imageView_reload);
		adinkra_desc = (TextSwitcher) findViewById(R.id.adinkra_desc);
		
		
		adinkra_desc.setFactory(new ViewSwitcher.ViewFactory() {
		    @Override
		...
		adinkra_desc.setInAnimation(this, android.R.anim.slide_in_left);
		adinkra_desc.setOutAnimation(this, android.R.anim.slide_out_right);
		
		
		//AUDAX EDITS ENDS HERE
...
//						Log.d("ThangTB", "touch move - x="+x+" y="+y+" id ="+imgTouch.getId());
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					case MotionEvent.ACTION_DOWN:
						...
						imgTouch = imageView;
						 ...
						 //Helped fix 4.4.x and 5.x issue of tiles reseting
	...
	//When Puzzle is complete this Method is executed plays the sounds too
	private void CompleteAddPuzz(){
		...
		//AUDAX EDITS HERE
		String name = puzzEntity.getAlphabet();
		
		if(name.equals("a")||name.equals("ba"))
		{
			//ADINKRAHENE
			adinkra_desc.setText(Html.fromHtml(" "
					+ "<h1><font color=white>ADINKRAHENE</font></h1> "
					+ "<br>"
					+ "<h3>Meaning : </h3>"
					+ "<p>\"Chief of adinkra symbols\"</p>"
					+ "<h3>Sybolism :</h3>"
		...
		else if(name.equals("b")||name.equals("bb"))
		{
			...
			//NYAME YE HENE
			adinkra_desc.setText(Html.fromHtml(" "
					+ "<h1><font color=white>NYAME YE HENE</font></h1> "
					+ "<br>"
					+ "<h3>Meaning : </h3>"
					+ "<p>\"God is King\"</p>"
					+ "<h3>Sybolism :</h3>"
		...
		else if(name.equals("c")||name.equals("bc"))
				{
			
				//ESE NE TEKREMA
			adinkra_desc.setText(Html.fromHtml(" "
					+ "<h1><font color=white>ESE NE TEKREMA</font></h1> "
					+ "<br>"
					+ "<h3>Meaning : </h3>"
					+ "<p>\"The teeth and the tongue\"</p>"
					+ "<h3>Sybolism :</h3>"
		...
		else if(name.equals("d")||name.equals("bd"))
		{
			
			//ANANSE NTENTAN
			adinkra_desc.setText(Html.fromHtml(" "
					+ "<h1><font color=white>ananse ntentan</font></h1> "
					+ "<br>"
					+ "<h3>Meaning : </h3>"
					+ "<p>\"spider's web\"</p>"
					+ "<h3>Sybolism :</h3>"
		...
		else if (name.equals("e")||name.equals("be"))
		{
			//DWENNIMMEN
			adinkra_desc.setText(Html.fromHtml(" "
					+ "<h1><font color=white>DWENNIMMEN</font></h1> "
					+ "<br>"
					+ "<h3>Meaning : </h3>"
					+ "<p>\"ram's horns\"</p>"
					+ "<h3>Sybolism :</h3>"
		...
		else if (name.equals("f")||name.equals("bf"))
		{
			//SANKOFA
			
			adinkra_desc.setText(Html.fromHtml(" "
					+ "<h1><font color=white>SANKOFA</font></h1> "
					+ "<br>"
					+ "<h3>Meaning : </h3>"
		...
		else
		{
			...
			adinkra_desc.setText(Html.fromHtml(" "
					...
					+ "<br>"
					+ "<h3>Meaning : </h3>"
					+ "<p>\"Change your attitude towards life\"</p>"
					+ "<h3>Sybolism :</h3>"
		...
		animDown.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				// TODO Auto-generated method stub
				//When flashing effect of the fixed image animation ends
				// The IF statement plays the pronouncer
				if (g==1 && mp!=null) {
					//mp.start();
				}
